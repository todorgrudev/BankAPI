...
def verifyCredentials(username, password):
    ...
    return None, False #No errors returned
...
class Transfer(Resource):
    def post(self):
        ...
        if not UserExist(to):
            return jsonify(generateReturnDictionary(301, "Reciever username is invalid"))
...
class Balance(Resource):
    def post(self):
        ...
        retJson = users.find({
            ...
            "Password": 0, #projection / hiding other strings
            "_id":0
        })[0]
